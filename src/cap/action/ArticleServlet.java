...
public class ArticleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("add")){
			int userId = Integer.parseInt(request.getParameter("userId"));	//����userId�����û��ĸ��˷���
			List<Category> cgList = cgService.getByUserId(userId);
			List<SysCategory> scgList = scService.getAllSysCategory();			//��ȡ����ϵͳ����			
			...
			if (res > 0) {	//��������³ɹ�
				request.getSession().setAttribute("succMsg", "�������³ɹ���");			
			} else {
				request.getSession().setAttribute("errorMsg", "��������ʧ��");				
			}
